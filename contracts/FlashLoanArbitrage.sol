...
contract FlashLoanArbitrage is FlashLoanSimpleReceiverBase {
    ...
    address private dexContractAddress =
        0x8355D2396779D117969E48c2755efDfC5F144981;
    ...
    function executeOperation(
        ...
        // Arbirtage operation
        usdc.approve(dexContractAddress, amount);

        dexContract.depositUSDC(amount); // 1000 USDC
        dexContract.buyDAI();
        dai.approve(dexContractAddress, dai.balanceOf(address(this)));
